...
allProperties = ["IntegerTrieRoundTrip"]
...
witnessesFor "IntegerTrieRoundTrip" =
  [ ( "witness_integer_trie_round_trip_case_neg_one"
    , W.witness_integer_trie_round_trip_case_neg_one )
  , ( "witness_integer_trie_round_trip_case_neg_three"
    , W.witness_integer_trie_round_trip_case_neg_three )
  , ( "witness_integer_trie_round_trip_case_neg_hundred"
    , W.witness_integer_trie_round_trip_case_neg_hundred )
  ]
witnessesFor _ = []
...
runQuickCheck "IntegerTrieRoundTrip" =
  qcDrive (QC.forAll GQ.gen_integer_trie_round_trip
                     (qcProp P.property_integer_trie_round_trip))
...
runHedgehog "IntegerTrieRoundTrip" =
  hhDrive GH.gen_integer_trie_round_trip P.property_integer_trie_round_trip
...
runFalsify "IntegerTrieRoundTrip" =
  fsDrive GF.gen_integer_trie_round_trip P.property_integer_trie_round_trip
...
runSmallCheck "IntegerTrieRoundTrip" =
  scDrive GS.series_integer_trie_round_trip P.property_integer_trie_round_trip
